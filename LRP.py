...
def main(
    ...
    dataset_root = os.path.join(dirname,dataset_root)
    relevance_format = os.path.join(dirname,relevance_format)
    ...
    if model_name is "react":
         ...
         model.load_state_dict(torch.load(os.path.join(dirname,"saved_models/classification/model.npy")))
